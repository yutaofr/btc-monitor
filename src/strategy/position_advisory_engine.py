...
class PositionAdvisoryEngine:
    ...
    def evaluate(self, observations: List[FactorObservation]) -> Recommendation:
        ...
        has_tactical_confirmation = tactical_info["tactical_bias"] in ["BULLISH_CONFIRMED", "BEARISH_CONFIRMED"]
        ...
        for o in observations:
            ...
            try:
                ...
                if defn.layer == Layer.RESEARCH.value: continue

                if action == PositionAction.ADD and o.score < -5.0:
                    if o.name == "EMA21_Weekly": continue
                    if defn.block == "macro_liquidity" and is_deep_value: continue
                    action = PositionAction.HOLD
                    confidence = 50
                ...
                if action == PositionAction.REDUCE and o.score > 5.0:
                    ...
                    if defn.layer == Layer.TACTICAL.value: continue
                    action = PositionAction.HOLD
                    confidence = 50
