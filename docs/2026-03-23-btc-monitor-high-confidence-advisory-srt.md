...
- Scope: Functional requirements, non-functional requirements, traceability, and acceptance-test contract
...
9. Fresh verification commands were run before completion is claimed.
